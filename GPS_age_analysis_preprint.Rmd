...
#for (v in 1:1) {
  ...
  # t <- tab_model(model.quad)
  # save_html(t, paste0(behav.lab, "_quadratic_model.html"))
  
  tab_model(model.quad, file = paste0(behav.lab, "_quadratic_model.html"))
