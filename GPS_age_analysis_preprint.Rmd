...
model.quad <- lmer(age ~ gender + financial_wellbeing + physical_wellbeing + subj_math_skills + poly(outcome,2) +
  ...
  save(model.quad, file = paste0("output/",pref.lab, "_quadratic_comparison.RData"))
  #load(model.quad, file = paste0("output/",pref.lab, "_quadratic_comparison.RData"))
...
aictab(cand.set = models, modnames = model.names) %>% kbl() %>%
