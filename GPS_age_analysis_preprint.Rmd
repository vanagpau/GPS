...
global_pref_map <- function(v, name) {
  ...
  draw_plot_label(name, x = -180, y = -30, hjust = 0, vjust = 0, angle = 90, size = axtitle, fontface = "plain")
  
}

global_pref_map(df.world$posrecip, "Positive Reciprocity")
global_pref_map(df.world$negrecip, "Negative Reciprocity")
global_pref_map(df.world$altruism, "Altruism")
global_pref_map(df.world$posrecip, "Trust")
global_pref_map(df.world, "Trust")
