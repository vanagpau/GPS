...
# load(paste0("output/Pref_lin_mod_refcat_",pref[v],".RData"))
# load(paste0("output/Pref_quad_mod_refcat_",pref[v],".RData"))
...
# load(paste0("output/Behav_lin_mod_refcat_",behav[v],".RData"))
# load(paste0("output/Behav_quad_mod_refcat_",behav[v],".RData"))
...
```{r model-comparisons, eval = TRUE, echo = FALSE}
