...
ggplot(prop, aes(fill=name, y=value, x=country)) +  geom_bar(position="dodge", stat="identity") + 
         scale_fill_brewer(palette = "Blues") + theme_bw() + coord_flip() + ylab("Proportion of sample") + theme(legend.position = "bottom", legend.title = element_blank())
...
ggplot (slice, aes(y=p, x=reorder(country, p))) +  geom_bar(stat="identity", fill="skyblue", alpha=0.7) + theme_bw() + coord_flip() + ylab("Proportion of sample") + theme(legend.position = "none")
