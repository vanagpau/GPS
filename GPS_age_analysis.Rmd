...
for (v in 1:length(vars)) {
  ...
  # create dataframe of model predictions for graphing (quicker than repeating model fit in ggplot)
  
  df.mod2 %>% mutate(model.out = predict(model.age, allow.new.level=TRUE))
