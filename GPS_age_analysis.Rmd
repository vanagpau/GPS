...
print(results.lin)
  ...
  # Plot quadratic and linear fit
    ...
    geom_smooth(data = df.mod_new, color = 'black', fill = 'black', linetype = "dotted", method = "lm", formula = y ~ poly(x,2), alpha = 0.3, size = 0.75, show.legend = FALSE) + # quadratic to 70
      
    geom_smooth(data = df.mod_new, color = 'black', linetype = "dashed", method = "lm", formula = y ~ x, alpha = 0.3, size = 0.6, show.legend = FALSE, se = FALSE) +  #linear to 70
